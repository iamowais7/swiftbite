  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        disabled={adding}
        onClick={addAddress}
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-brand-dark disabled:opacity-50"
      >
          ...
          addresses.map((addr, i) => (
            ...
            >
              ...
              <motion.button
                ...
                className="shrink-0 rounded-lg p-2 text-brand hover:bg-brand/10 disabled:opacity-50"
              >
                {deletingId === addr._id ? (
