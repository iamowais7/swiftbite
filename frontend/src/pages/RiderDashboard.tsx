    ...
    return (
      <div className="min-h-screen bg-gray-50 px-4 py-6">
        <motion.div
          ...
          className="mx-auto max-w-lg space-y-5 rounded-2xl bg-white p-6 shadow-[0_2px_10px_rgba(0,0,0,0.06)]"
        >
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-md px-4 py-4">
        <div className="space-y-4 rounded-2xl bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
          ...
          <div className="flex justify-center gap-2">
            <span className={`flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold ${profile.isVerified ? "bg-green-100 text-green-600" : "bg-yellow-100 text-yellow-600"}`}>
              {profile.isVerified ? <BiCheckCircle className="h-3.5 w-3.5" /> : <BiTimeFive className="h-3.5 w-3.5" />}
              {profile.isVerified ? "Verified" : "Pending"}
            </span>
            <span className={`flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold ${profile.isAvailable ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"}`}>
              <span className={`h-1.5 w-1.5 rounded-full ${profile.isAvailable ? "bg-green-500" : "bg-gray-400"}`} />
            ...
            <div className="flex items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4">
              <div className="flex items-center gap-3">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-100">
                  <BiBell className="h-4.5 w-4.5 text-blue-600" />
                </span>
                <div>
      ...
      <AnimatePresence>
        {profile.isAvailable && incomingOrders.length > 0 && (
          ...
          >
            <h3 className="flex items-center gap-1.5 font-bold text-gray-700">
