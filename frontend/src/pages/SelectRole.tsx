  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-linear-to-br from-[#fff3f2] via-[#fff8f5] to-white px-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm space-y-6 rounded-3xl bg-white/90 p-8 shadow-[0_20px_60px_rgba(226,55,68,0.12)] backdrop-blur-sm"
      >
        {/* Brand */}
            ...
            <motion.button
              ...
              className={`flex w-full items-center gap-3 rounded-2xl border px-4 py-3.5 text-sm font-semibold capitalize shadow-[0_2px_10px_rgba(0,0,0,0.06)] transition ${
                role === r
                  ...
                  : "border-gray-200 bg-white text-gray-700 hover:shadow-[0_10px_25px_rgba(226,55,68,0.12)]"
              }`}
            >
